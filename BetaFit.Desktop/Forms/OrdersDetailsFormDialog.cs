...
{
    public partial class OrdersDetailsFormDialog : Form
    {
        ...
        public OrdersDetailsFormDialog() : this(new OrderResponseDto()) { }

        public OrdersDetailsFormDialog(OrderResponseDto pedido)
        {
            _pedido = pedido;
            InitializeComponent();
            MontarConteudo();
        ...
        private void MontarConteudo()
        {
            ...
            lblCliente.Text = $"Cliente: {_pedido.UserId}";
            ...
            lblQtdItens.Text = $"{_pedido.Items?.Sum(i => i.Quantity) ?? 0} ITEM(NS)";
